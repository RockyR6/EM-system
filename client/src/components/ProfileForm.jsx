...
const ProfileForm = ({initialData, onSuccess}) => {
  ...
  return (
    <form onSubmit={handleSubmit} className='card p-5 sm:p-6 mb-6'>
        ...
        {message && (
          <div className='bg-emerald-50 text-emerald-700 p-4 rounded-xl text-sm border border-r-emerald-200 mb-6 flex items-start gap-3'>
          ...
          {initialData.isDeleted ? (
            <div className='pt-2'>
              <div className='p-4 bg-rose-50 border border-rose-200 rounded-xl text-center'>
                ...
                <p className='text-sm text-rose-500 mt-0.5'>You can longer update your profile.</p>
              </div>
            </div>
          ) : (
