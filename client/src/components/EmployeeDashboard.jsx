import { ArrowBigRightIcon, Calendar1Icon, DollarSignIcon, FileTextIcon, Subtitles } from 'lucide-react';
    ...
    <div className='animate-fade-in'>
      ...
      <div className='flex flex-col sm:flex-row gap-3'>
        <Link to='/attendance' className='btn btn-primary text-center inline-flex items-center justify-center gap-2'>
          Mark Attendance <ArrowBigRightIcon className='w-4 h-4'/>
        </Link>
        <Link to='/leaves' className='btn btn-secondary text-center '>
          Apply for Leave <ArrowBigRightIcon className='w-4 h-4'/>
        </Link>
      </div>
    </div>
  )
