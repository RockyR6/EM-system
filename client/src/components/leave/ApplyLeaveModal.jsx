import { FileText, X, CalendarDays, Loader2, Send } from "lucide-react";
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button onClick={onClose} disabled={loading} type='submit' className="btn-primary flex-1 items-center justify-center gap-1">
                {loading ? <Loader2 className="w-4 h-4 animate-spin"/> : <Send className="w-4 h-5 pt-4"/>}
