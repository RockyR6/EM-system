                          ...
                          <td>
                            {leave.status === 'PENDING' && (
                              <div className='flex justify-center gap-2'>
                                <button disabled={!!processing} onClick={()=> handlestatusUpdate(leave._id || leave.id, 'APPROVED')}
                                ...
                                <button disabled={!!processing} onClick={()=> handlestatusUpdate(leave._id || leave.id, 'REJECTED')}
