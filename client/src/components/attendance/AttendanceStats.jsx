import { AlertCircle, Calendar, ClockIcon } from 'lucide-react'
...
const AttendanceStats = ({ history }) => {
 ...
 const stats = [
  { id: 'present', label: 'Days Present', value: totalPresent, icon: Calendar },
  { id: 'late', label: 'Late Arrivals', value: totalLate, icon: AlertCircle },
  { id: 'avg', label: 'Avg. Work Hrs', value: '8.5 Hrs', icon: ClockIcon }
]
  return (
